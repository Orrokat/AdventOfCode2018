...
// var moveForward = 10900 // had to start this many seconds forward because javascript could not handle the size of the string
function getPointsOfLight (positionVelocityArray, moveForward) {
...
function getPointsOfLightForCanvas (positionVelocityArray, moveForward) {
  var positionVelocityObjectArray = parseData(positionVelocityArray)
  advanceLights(positionVelocityObjectArray, moveForward)
  var jsonPositionArray = JSON.stringify(positionVelocityObjectArray)
  return jsonPositionArray
}
...
exports.getPointsOfLightForCanvas = getPointsOfLightForCanvas
